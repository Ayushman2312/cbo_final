...
function openDeleteModal(deleteUrl, modalId) {
...
function searchEvents() {
    ...
    let eventCards = document.querySelectorAll('.grid > div');

    eventCards.forEach(card => {
        let eventName = card.querySelector('h3').textContent.toLowerCase();
